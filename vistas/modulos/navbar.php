<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <a style="cursor: pointer;" class="nav-link"
                                onclick="cargarContenido('vistas/dashboard.php', 'content-wrapper')">Tablero</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        <a style="cursor: pointer;" class="nav-link"
        ...
        <li class="nav-item d-none d-sm-inline-block">
        <a style="cursor: pointer;" class="nav-link"
                                onclick="cargarContenido('vistas/reportes.php', 'content-wrapper')">Reportes</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
        <a style="cursor: pointer;" class="nav-link"
                                onclick="cargarContenido('vistas/configuracion.php', 'content-wrapper')">Configuración</a>
        </li>
    </ul>
</nav>
